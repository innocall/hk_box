...
public class SmoothButton extends Button {
	...
	public int getTransitionDrawableLength() {
		return transitionDrawableLength;
	}

	public void setTransitionDrawableLength(int transitionDrawableLength) {
		this.transitionDrawableLength = transitionDrawableLength;
	}
