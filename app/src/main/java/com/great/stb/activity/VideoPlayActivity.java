...
public class VideoPlayActivity extends Activity implements OnClickListener,
	...
	public void onResume() {
		super.onResume();
		MobclickAgent.onPageStart("VideoPlayActivity"); //统计页面(仅有Activity的应用中SDK自动调用，不需要单独写。"SplashScreen"为页面名称，可自定义)
	...
	public void onPause() {
		super.onPause();
		MobclickAgent.onPageEnd("VideoPlayActivity"); // （仅有Activity的应用中SDK自动调用，不需要单独写）保证 onPageEnd 在onPause 之前调用,因为 onPause 中会保存信息。"SplashScreen"为页面名称，可自定义
