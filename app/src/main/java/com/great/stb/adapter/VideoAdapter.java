...
public class VideoAdapter extends BaseAdapter {
	...
	public VideoAdapter(Context context,List<Music> listMusic){
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(convertView==null){
			convertView=LayoutInflater.from(context).inflate(R.layout.list_local_video_item, null);
		}
...
//		textMusicName.setText(m.getUrl());
		//歌手
